    ...
    >
      ...
      >
        <div className="flex items-center gap-2">
          ...
          <span className="hud-text text-[12px] text-[var(--text-primary)]">ฟีด SIGINT</span>
          ...
          {news.some((n: any) => n.risk_score >= 8) && (
            <span className="gotham-tag gotham-tag--critical" style={{ fontSize: '7px', padding: '1px 4px' }}>แจ้งเตือน</span>
          )}
        </div>
        <div className="flex items-center gap-2">
