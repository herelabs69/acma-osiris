          ...
          >
            <div className="flex items-center justify-between mb-3">
              <div className="flex items-center gap-2">
                ...
                <span className="hud-text text-[10px] text-[var(--text-primary)]">แชร์มุมมอง</span>
              </div>
            ...
            <div className="mb-3 p-2 rounded-lg bg-[var(--bg-void)] border border-[var(--border-primary)]">
              <div className="flex items-center gap-1.5 mb-1">
                ...
                <span className="text-[7px] font-mono text-[var(--text-muted)] tracking-widest">มุมมองปัจจุบัน</span>
              </div>
            ...
            <div className="mb-3">
              <div className="flex items-center gap-1.5 mb-1">
                ...
                <span className="text-[7px] font-mono text-[var(--text-muted)] tracking-widest">ลิงก์สำหรับแชร์</span>
              </div>
