...
const SHORTCUTS = [
  { key: 'F', desc: 'สลับเต็มจอ' },
  { key: 'S', desc: 'แชร์มุมมองปัจจุบัน' },
  { key: 'L', desc: 'เปิด/ปิดแผงเลเยอร์' },
  { key: 'M', desc: 'เปิด/ปิดแผงตลาด' },
  { key: 'I', desc: 'เปิด/ปิดฟีดข่าวกรอง' },
  { key: 'R', desc: 'รีเซ็ตเป็นมุมมองโลก' },
  { key: '?', desc: 'แสดงวิธีใช้' },
  { key: 'ESC', desc: 'ปิดแผง / ป๊อปอัป' },
];
          ...
          >
            <div className="flex items-center justify-between mb-4">
              <div className="flex items-center gap-2">
                ...
                <span className="text-sm font-mono font-bold text-[var(--text-heading)] tracking-wider">คีย์ลัด</span>
              </div>
