...
const SITE_TITLE = "OSIRIS — แพลตฟอร์มข่าวกรองโอเพนซอร์ส | ติดตามเครื่องบิน CCTV และเครื่องมือ OSINT แบบเรียลไทม์";
const SITE_DESCRIPTION = "แพลตฟอร์มข่าวกรองโอเพนซอร์ส รวมการติดตามเครื่องบิน ดาวเทียม กล้อง CCTV แผ่นดินไหว ไฟป่า ภัยคุกคามไซเบอร์ และความขัดแย้งทั่วโลกบนแผนที่ 3 มิติแบบเรียลไทม์ พร้อมชุดเครื่องมือ OSINT (สแกนพอร์ต, DNS, WHOIS, SSL, ข่าวกรองภัยคุกคาม) ใช้งานฟรีผ่านเบราว์เซอร์";
